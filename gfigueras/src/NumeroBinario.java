...
public class NumeroBinario {
  ...
  public static Integer[] mensaje() {
    Integer[] mensaje = new Integer[tamaño];
  ...
  public static void calcularParidad() {
    ...
    } while ((mensaje().length + 3 + 1) > Math.pow(2, i));
    bitParidad = i;
...
// }
// if (noise == 1) {
// mensaje.set((arrayPosiciones[0]), ((mensaje.get(arrayPosiciones[0]) + 1) %
// 2));
// }
...
// mensaje.set((arrayPosiciones[0]), ((mensaje.get(arrayPosiciones[0]) + 1) %
// 2));
// mensaje.set((arrayPosiciones[1]), ((mensaje.get(arrayPosiciones[1]) + 1) %
// 2));
// }
// // System.out.println(Arrays.toString(arrayPosiciones) + "TAMAÑO DEL MENSAJE
// =="
// // + codigoHamming.size());
// }
// }
...
// }
// if (cuenta > 0)
// System.out.println("\u001B[31m<======El mensaje ha sufrido
// daños======>\u001B[37ms");
// else
// System.out.println("\u001B[32m<=====El mensaje no ha sufrido
// daños======>\u001B[37ms");
